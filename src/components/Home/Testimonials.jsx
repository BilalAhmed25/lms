                                        ...
                                        <div className="stars-container">
                                            {[...Array(5)].map((_, i) => (
                                                <Star
                                                    key={i}
                                                    size={16}
                                                    fill={i < Math.round(review.rating) ? "var(--accent)" : "transparent"}
                                                    color={i < Math.round(review.rating) ? "var(--accent)" : "#e5e7eb"}
                                                    className={i < Math.round(review.rating) ? "star-filled" : "star-empty"}
                                                />
                                            ))}
                                        </div>
